/* global AFRAME */
// the following code is for the INFO button at the bottom left corner of the screen
AFRAME.registerComponent('info-message', {
    ...
    init: function () {
      ...
      var infoTextEl = this.infoTextEl = document.createElement("p");
      infoTextEl.innerHTML = "Click around and explore this virtual tour! Use your mouse to move the pointer at the center of what you would like to select, then click!";
      infoTextEl.style = "color: blue; font-family: Arial, Helvetica, sans-serif;"
    ...
    update: function () {
      ...
      messageEl.appendChild(this.infoTextEl);
    },
